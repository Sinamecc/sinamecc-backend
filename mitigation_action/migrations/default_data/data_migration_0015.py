_sustainable_development_goals = [
    ...
    },
    {
        ...
        'description_en': 'Ensure an inclusive, equitable and quality education and promote opportunities of learning throughout the life for all',
    },
    {
        'code': '5',
    ...
    },
    {
        ...
        'description_en': 'Guarantee the availability of water and its sustainable management and sanitation for all'
    },
    {
        'code': '7',
        'description_es': 'Garantizar el acceso a una energía asequible, segura, sostenible y moderna',
        'description_en': 'Ensure access to an affordable, secure, sustainable and modern energy'
    },
    {
        'code': '8',
        'description_es': 'Promover el crecimiento económico inclusivo y sostenible, el empleo y el trabajo decente para todos',
        'description_en': 'Promote economic growth inclusive and sustainable, employment and decent work for all'
    },
    {
        'code': '9',
        'description_es': 'Construir infraestructuras resilientes, promover la industrialización sostenible y fomentar la innovación',
        'description_en': 'Build resilient infrastructure, promote sustainable industrialization and promote innovation'
    },
    {
        'code': '10',
        'description_es': 'Reducir la desigualdad en y entre los países',
        'description_en': 'Reduce inequality in and between countries'
    },
    {
        'code': '11',
        'description_es': 'Lograr que las ciudades sean más inclusivas, seguras, resilientes y sostenibles',
        'description_en': 'Achieve cities more inclusive, secure, resilient and sustainable'
    },
    {
        'code': '12',
        'description_es': 'Garantizar modalidades de consumo y producción sostenibles',
        'description_en': 'Ensure sustainable consumption and production modes'
    },
    {
        'code': '13',
        'description_es': 'Adoptar medidas urgentes para combatir el cambio climático y sus efectos',
        'description_en': 'Adopt measures to combat climate change and its effects'
    },
    {
        'code': '14',
        'description_es': 'Conservar y utilizar sosteniblemente los océanos, los mares y los recursos marinos',
        'description_en': 'Preserve and use sustainable oceans, seas and marine resources'
    },
    {
        'code': '15',
        ...
        'description_en': 'Manage sustainable forests, fight against desertification, stop and invest in the degradation of the lands, stop the loss of biodiversity'
    },
    {
        'code': '16',
...
_ghg_impact_sector = [
    ...
    {
        'code': '3',
        'name_es': 'Procesos Industriales y Uso de Productos (IPPU)',
        'name_en': 'Industrial processes and use of products (IPPU)',
    },
    {
        'code': '4',
        'name_es': 'Residuos',
    ...
    {
        'code': '5',
        'name_es': 'Uso de la tierra, cambio del uso de la tierra y silvicultura (UTCUTS)',
        'name_en': 'Land use, change in land use and forestry (UTCUTS)',
    }
]
