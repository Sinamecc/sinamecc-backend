...
from mitigation_action.serializers import ImpactCategorySerializer
...
from mitigation_action.migrations.default_data.data_migration_0005 import _geographic_scale_data, _finance_source_type_data, \
    _finance_status_data, _initiative_type_data, _status_data, _impact_category_data
...
def insert_form_data(apps, schema_editor):
    ...
    ImpactCategory = apps.get_model('mitigation_action', 'ImpactCategory')

    model_and_data = {
        InitiativeType: _initiative_type_data, GeographicScale: _geographic_scale_data, FinanceSourceType: _finance_source_type_data,
        FinanceStatus: _finance_status_data, Status: _status_data, ImpactCategory: _impact_category_data
    }
