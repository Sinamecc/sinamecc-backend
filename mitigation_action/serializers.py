...
class MonitoringIndicatorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'initial_date_report_period', 'final_date_report_period', 'data_updated_date', 'source_type', 'updated_data', 'progress_report_period', 'progress_report', 'indicator', 'monitoring_reporting_indicator')
